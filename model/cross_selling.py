...
def customer_clustering(data, group_by_columns, num_clusters=10, n_init=10, mode="infer", model_path="./retail_customer.pkl"):
    data_for_clustering = data[group_by_columns]
...
def write_to(association_rule_results:dict,antecedents,filepath="../resultfiles/cross_selling.txt",mode="a+",encoding='gbk'):
